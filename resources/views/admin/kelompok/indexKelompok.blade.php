                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 my-auto text-right">
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-secondary text-center" ><a href="/admin/kelompok/index-nonaktif/{{$id_kls}}/{{$id_per}}" style="color: white;">Non Aktif</a></button>
                                </div>                            
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table table-bordered text-center" id="table-test" width="100%" cellspacing="0">
                                ...
                                @foreach($kelompok as $kel)
                                    <tr>
                                        ...
                                        <td><span class="badge badge-pill badge-primary">{{$kel->statusKelompok}}</span></td>
                                        <td>
