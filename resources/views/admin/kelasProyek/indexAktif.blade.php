                                ...
                                <div class="tile-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12"><b>Maksimal Anggota Proyek :</b>
                                            <div class="form-group">
                                                <input class="form-control" type="number" name="maksAnggota" placeholder="1, 2, 3 dsb...">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="tile-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12"><b>Maksimal Anggota:</b>
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="maksAnggota" id="maksAnggota" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
